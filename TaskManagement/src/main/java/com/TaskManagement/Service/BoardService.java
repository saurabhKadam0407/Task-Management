...
public class BoardService {
	...
	public BoardCard addIssueToBoard(Long boardId,Long columnId,Long IssueId) {
		...
		BoardColumn column= boardCoumnRepo.findById(columnId).orElseThrow(()-> new RuntimeException("column not found"));
...
//		}
	...
	public void moveCards(Long boardId,Long cardId,Long columnId, int position,String performedBy) {
		...
		List<BoardCard>fromList= boardCardRepo.findByBoardIdAndColumnIdOrderByPosition(boardId, fromStatus.getId());
		...
		List<BoardCard>toList= boardCardRepo.findByBoardIdAndColumnIdOrderByPosition(boardId, toStatus.getId());
